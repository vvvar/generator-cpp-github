...
module.exports = class extends Generator {
  ...
  async initializing() {
    ...
    if (this._isConfigAvailable()) {
      if (this.config.get("GeneratorType") !== "lib") {
  ...
  async writing() {
    ...
    await this.fs.copyTpl(this.templatePath("examples"), this._destPath("examples"), CONFIG);
    await this.fs.copyTpl(this.templatePath("include"), this._destPath("include"), CONFIG);
